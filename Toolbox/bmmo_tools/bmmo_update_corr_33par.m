function [corr_out, res_out] = bmmo_update_corr_33par(corr_in)
% function [corr_out, res_out] = bmmo_update_corr_33par(corr_in)
%
% Update sbc intrafield correction with 33par model
%
% Input: corr_in: BMMO-NXE SBC2 correction structure
%   
% Output: corr_out: BMMO-NXE SBC2 correction structure after 18par
%            residual removed
%         res_out: modelled 33par residual
...
res = ovl_model(flds, options.CET33par.name, 'perwafer');
