function mlo = bmmo_get_meas_data_bmmo(wafers_out, expinfo, phase)
...
ml_exp = bmmo_kt_ml_from_expinfo(expinfo);
...
mlo = bmmo_KT_2_ml(wafers_out, USE_LAYOUT, ml_exp, 'BMMO', 'XPA');
...
% Verify mark positions after YS readout field shifts
mls = bmmo_shift_fields(mlo, -XF_SHIFT, -YF_SHIFT);
xw_yw = [mls.wd.xw, mls.wd.yw];

[~,D] = knnsearch(xw_yw, e_xc_yc);
